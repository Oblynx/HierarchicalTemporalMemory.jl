...
"""
    TemporalMemory(params::TMParams; recurrent= true, distal_input=[])
...
- `distal_input`: vector of the number of presynaptic neurons for each layer with incoming distal connections
...
function step!(tm::TemporalMemory, c, distal_input=[])
...
See also: [`tm_activate`](@ref), [`tm_predict`](@ref)
"""
(tm::TemporalMemory)(c, distal_input=[])= begin
